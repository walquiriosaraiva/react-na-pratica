    ...
    <div className="max-w-[1200px] mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col items-end gap-0.5">
          <span className="text-sm font-medium">Walquirio Saraiva</span>
          <span className="text-xs text-zinc-400">walquiriosaraiva@gmail.com</span>
        </div>
        <img
          src="https://github.com/walquiriosaraiva.png"
